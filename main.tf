...
resource "google_cloud_run_service" "bqtest" {
  name     = "bq-query-by-id"
  location = var.region
...
resource "google_cloud_run_service_iam_policy" "noauth" {
  location    = google_cloud_run_service.bqtest.location
  project     = google_cloud_run_service.bqtest.project
  service     = google_cloud_run_service.bqtest.name
